...
from backend.memory.event_memory import log_event, get_recent_events
...
def test_event_logging_and_similarity():
    ...
    try:
        ...
        # Log past anomaly with features
        ...
        # Log maintenance record shortly after
        record_maintenance(
            db=db,
            asset_id="TEST-MEM-01",
            issue="Bearing wear",
        ...
        # Query similarity with matching pattern
