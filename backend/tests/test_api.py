...
def test_end_to_end_flow():
    ...
    # 4. Ingest high vibration anomalous telemetry
    for _ in range(3):
    ...
    # 5. Analyze anomalous condition -> triggers shutdown / inspection & STOP command
    ...
    # 6. Check pending commands for ESP32 and acknowledge
    ...
    # 7. Check health summary endpoint
    ...
    # 8. Record maintenance and verify health recovery
    ...
    assert maint_res.json()["component"] == "Main Bearing"

    # Verify asset health was restored by maintenance
    ...
    # 9. Query ORACLE Memory for similar past events
    ...
    # 10. Check batch telemetry ingestion
